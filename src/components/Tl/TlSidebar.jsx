...
const companyNav = [
  { name: "Overview", Icon: ChartArea, link: "/admin" },
  { name: "Members", Icon: FolderKanban, link: "/admin/departments" },
  { name: "Tasks", Icon: Database, link: "/admin/video-meet" },
